...
<script>
        ...
        $('[ name="add-link"]').on('click', function(e){
            e.preventDefault();
            $("#main-content").load('barangay-add.php');
        });

        $('[name="edit-link" ]').on('click', function(e){
            e.preventDefault();
            var id = $(this).attr('href');
            $("#main-content").load('barangay-edit.php', {id: id});
        });
    });
</script>

<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Barangay</h1>
    ...
    <table class="table table-striped" name="sampple-tbl">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?=MunicipalityController::GetById($r['municipality_id'])->Name?></td>
                <td><?=ProvinceController::GetById(MunicipalityController::GetById($r['municipality_id'])->ProvinceId)->Name?></td>
                <td>
                    <div class="d-flex">
                        <a href="<?=$r['barangay_id']?>" name="edit-link" class="me-3 text-decoration-none">
