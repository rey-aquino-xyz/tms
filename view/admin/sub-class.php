    ...
    $(document).ready(function(){
        ...
        $('[name="sampple-tbl"]').DataTable({
            ...
            //  'csv', 'excel', 'pdf',
                {
                    extend: 'print',
                    title: 'Property Sub Classification',
                    messageTop: 'List of Available Property Sub Classification',
                    exportOptions: {
                        columns: ':visible'
                    }
                },
        ...
        $('[name="add-link"]').on('click', function(e){
            e.preventDefault();
            $("#main-content").load('sub-class-add.php');
        });

        $('[name="edit-link"]').on('click', function(e){
            e.preventDefault();
            var id = $(this).attr('href');
            $("#main-content").load('sub-class-edit.php', {id:id});
        });
    });
</script>

<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Sub Classification</h1>
    ...
    <table class="table table-striped" name="sampple-tbl">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <div class="d-flex">
                        <a href="<?=$r['sub_class_id']?>" name="edit-link" class="me-3 text-decoration-none"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
