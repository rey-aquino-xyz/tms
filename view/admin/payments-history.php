...
<div>
    <p>
        <h4><?=strtoupper($UserInfo->Name)?></h4>
        <?=BarangayController::GetById($PropertyInfo->BrgyId)->Name . ', ' . MunicipalityController::GetById($PropertyInfo->MunicipalityId)->Name, ', ' . ProvinceController::GetById($PropertyInfo->ProvinceId)->Name?>
    </p>
    <p>Payment History</p>
</div>
