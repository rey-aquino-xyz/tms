...
$UserInfo = UserController::GetByContact($_SESSION['contact']);
    ...
    <div id="root">
        <div class="container pt-5">
            <div class="row align-items-stretch">
                <div class="c-dashboardInfo col-lg-3 col-md-6">
                    <div class="wrap">
                        <h4 class="heading heading5 hind-font medium-font-weight c-dashboardInfo__title">Total
                            ...
                            <?php $amount = 0;?>
                            <?php foreach(PropertyController::GetByUserId($UserInfo->UserId) as $r):?>
                                <?php $amount += PaymentController::GetAllCollectionByTDN($r['tdn']);?>
                            <?php endforeach;?>
                ...
                <div class="c-dashboardInfo col-lg-3 col-md-6">
                    <div class="wrap">
                        <h4 class="heading heading5 hind-font medium-font-weight c-dashboardInfo__title">Amount Due</h4>
                ...
                <div class="c-dashboardInfo col-lg-3 col-md-6">
                    <div class="wrap">
                        ...
                        <?=PropertyController::GetTotalPropertyByUserId($UserInfo->UserId);?>
                        </span>
                    </div>
                </div>
            </div>
...
<div class="table-responsive">
    <table class="table table-striped table-sm" name="sampple-tbl">
        ...
        <tbody>
            <?php foreach(PaymentController::GetPaymentByUserId($UserInfo->UserId) as $r): ?>
                <tr>
                <?php $PropertyInfor = PropertyController::GetByTDN($r['tdn']);?>
               <td><?=$r['date_paid']?></td>
               <td><?=$r['tdn']?></td>
               <td><?=number_format(PaymentController::GetAssesmentValue($r['tdn'], $r['tax_year']), 2)?></td>
               <td><?=number_format($r['tax_year'],2)?></td>
